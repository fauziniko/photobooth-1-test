...
"[project]/src/app/photo/uploaded/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function UploadedPhotosPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UploadedPhotosPage.useEffect": ()=>{
            ...
            const loadSavedPhotos = {
                "UploadedPhotosPage.useEffect.loadSavedPhotos": async ()=>{
                    let savedPhotos = [];
                    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$indexedDB$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isIndexedDBSupported"])()) {
                        try {
                            const cached = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$indexedDB$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadPhotosFromIndexedDB"])();
            ...
            }["UploadedPhotosPage.useEffect.loadSavedPhotos"];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UploadedPhotosPage.useEffect": ()=>{
            const persistPhotos = {
                "UploadedPhotosPage.useEffect.persistPhotos": async ()=>{
                    if (photos.length === 0) {
                    ...
                    const savedToSession = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$tempPhotoStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveTempPhotosToSessionStorage"])(photos);
                    if (savedToSession) {
                        persisted = true;
                    }
                    if (persisted) {
            ...
            }["UploadedPhotosPage.useEffect.persistPhotos"];
            void persistPhotos();
        }
    }["UploadedPhotosPage.useEffect"], [
        photos
    ...
    const handleFileSelect = (files)=>{
        ...
        Array.from(files).forEach((file)=>{
            ...
            if (file.size > maxSize) {
                setError("File ".concat(file.name, " is too large (maximum 5MB)."));
                return;
            }
            ...
            reader.onload = (e)=>{
                try {
                    ...
                    if (!isValidPhotoData(result)) {
                        setError("Unsupported image format for ".concat(file.name, "."));
                        return;
                    }
                    setPhotos((prev)=>[
                            ...prev,
    ...
    const goToEditor = async ()=>{
        if (photos.length >= layout) {
            ...
            router.push("/photo/edit?layout=".concat(layout));
        }
    };
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        onDrop: handleDrop,
                        className: "mb-12 border-3 border-dashed rounded-2xl p-10 text-center transition ".concat(isDragging ? 'border-[#fa75aa] bg-[#fff0f7]' : 'border-[#f3b7d1] bg-white'),
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    photos.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: photos.map((photo, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    ...
                                                    title: "Remove photo",
                                                    "aria-label": "Remove photo ".concat(idx + 1),
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$trash$2d$2$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Trash2$3e$__["Trash2"], {
                                                        size: 20
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/photo/uploaded/page.tsx",
                                    ...
                                    }, "".concat(idx, "-").concat(photo.slice(0, 20)), true, {
                                        fileName: "[project]/src/app/photo/uploaded/page.tsx",
                                        lineNumber: 288,
                                        columnNumber: 17
                                    }, this))
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    className: "inline-flex items-center gap-2 px-8 py-4 rounded-xl font-bold text-lg transition ".concat(photos.length >= layout ? 'bg-[#fa75aa] text-white hover:bg-[#ec6aa9] active:scale-95' : 'bg-gray-300 text-gray-500 cursor-not-allowed'),
                                    children: [
                                        ...
                                        photos.length >= layout ? "Continue to Editor (".concat(photos.length, "/").concat(layout, ")") : "Need ".concat(layout - photos.length, " more photo(s)")
                                    ]
                                }, void 0, true, {
                                    fileName: "[project]/src/app/photo/uploaded/page.tsx",
                                    lineNumber: 319,
...
_s(UploadedPhotosPage, "dt1q97SPUImVOlfuEsHC9p2Hc60=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = UploadedPhotosPage;
var _c;
__turbopack_context__.k.register(_c, "UploadedPhotosPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_7122f2ff._.js.map