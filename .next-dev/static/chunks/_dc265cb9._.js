...
"[project]/src/app/photo/gallery/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PhotoGalleryPage() {
    ...
    const [editingGalleryId, setEditingGalleryId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const fetchDatabaseGallery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PhotoGalleryPage.useCallback[fetchDatabaseGallery]": async ()=>{
            try {
                ...
                const rows = Array.isArray(data === null || data === void 0 ? void 0 : data.items) ? data.items : [];
                return rows.map({
                    "PhotoGalleryPage.useCallback[fetchDatabaseGallery]": (row)=>({
                            id: row.id,
                ...
                }["PhotoGalleryPage.useCallback[fetchDatabaseGallery]"]);
            } catch (e) {
                return [];
            }
        }
    }["PhotoGalleryPage.useCallback[fetchDatabaseGallery]"], []);
    const loadGallery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PhotoGalleryPage.useCallback[loadGallery]": async ()=>{
            setIsLoading(true);
            const dbItems = await fetchDatabaseGallery();
            setItems(dbItems.sort({
                "PhotoGalleryPage.useCallback[loadGallery]": (a, b)=>new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()
            }["PhotoGalleryPage.useCallback[loadGallery]"]));
            setIsLoading(false);
        }
    }["PhotoGalleryPage.useCallback[loadGallery]"], [
    ...
    const confirmDeleteItems = async ()=>{
        ...
        await Promise.all(confirmDelete.ids.map((id)=>fetch("/api/gallery/".concat(id), {
                method: 'DELETE'
            }).catch(()=>null)));
    ...
    const handleDeleteSelected = async ()=>{
        ...
        requestDeleteItems([
            ...selectedIds
        ], 'Delete Selected Photos', "Delete ".concat(selectedIds.length, " selected photos?"));
    };
    ...
    const handleEditInEditor = async (id)=>{
        ...
        try {
            ...
            const data = await res.json();
            const detail = data === null || data === void 0 ? void 0 : data.item;
            const sourcePhotos = [
                ...Array.isArray(detail === null || detail === void 0 ? void 0 : detail.photoFrames) ? detail.photoFrames : []
            ];
            if (sourcePhotos.length === 0 && Array.isArray(detail === null || detail === void 0 ? void 0 : detail.livePhotos)) {
                sourcePhotos.push(...detail.livePhotos);
            }
            if (sourcePhotos.length === 0) {
                if (typeof (detail === null || detail === void 0 ? void 0 : detail.stripDataUrl) === 'string' && detail.stripDataUrl) sourcePhotos.push(detail.stripDataUrl);
                else if (typeof (detail === null || detail === void 0 ? void 0 : detail.previewDataUrl) === 'string' && detail.previewDataUrl) sourcePhotos.push(detail.previewDataUrl);
                else if (typeof (detail === null || detail === void 0 ? void 0 : detail.imageUrl) === 'string' && detail.imageUrl) sourcePhotos.push(detail.imageUrl);
            }
            ...
            if (typeof (detail === null || detail === void 0 ? void 0 : detail.liveVideoDataUrl) === 'string' && detail.liveVideoDataUrl.length > 0) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$tempPhotoStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveTempLiveVideoUrlToSessionStorage"])(detail.liveVideoDataUrl);
            } else {
            ...
            const nextLayout = Number.isFinite(Number(detail === null || detail === void 0 ? void 0 : detail.layout)) ? Number(detail.layout) : Math.max(1, normalizedPhotos.length);
            router.push("/photo/edit?layout=".concat(nextLayout, "&source=gallery&id=").concat(detail.id));
        } catch (e) {
                ...
                children: [
                    ...
                    isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: items.map((item)=>{
                            const itemLink = "/photo/gallery/".concat(item.id);
                            const isEditing = editingId === item.id;
                            const isSelected = selectedIds.includes(item.id);
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("article", {
                                className: "bg-white rounded-xl shadow-sm border overflow-hidden transition ".concat(isSelected ? 'border-[#d72688] ring-2 ring-pink-200' : 'border-pink-100'),
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                            src: item.imageSrc,
                                            alt: "gallery-item-".concat(item.id),
                                            loading: "lazy",
                                            decoding: "async",
...
_s(PhotoGalleryPage, "ai6Rsnb4jkDEP6G7ZnQLZRmt7lM=", false, function() {
    return [
...
_c = PhotoGalleryPage;
var _c;
__turbopack_context__.k.register(_c, "PhotoGalleryPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_dc265cb9._.js.map